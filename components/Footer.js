const Footer = () => (
    <footer className="block w-full bg-[#212529] " aria-labelledby="footer-heading">
      <h2 id="footer-heading" className="sr-only">Footer</h2>
      <div className="py-12  max-w-7xl mx-auto  md:flex md:items-center md:justify-between">
